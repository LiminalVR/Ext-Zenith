...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:4730,x:32719,y:32712,varname:node_4730,prsc:2|diff-5054-RGB;n:type:ShaderForge.SFN_Tex2d,id:5054,x:32378,y:32888,ptovrint:False,ptlb:MainTex,ptin:_MainTex,varname:node_5054,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:ad2d95b8412f871418cff16114d6cc5d,ntxv:0,isnm:False|UVIN-2771-OUT;n:type:ShaderForge.SFN_Panner,id:4899,x:31741,y:32804,varname:node_4899,prsc:2,spu:1,spv:0|UVIN-4594-UVOUT,DIST-7547-OUT;n:type:ShaderForge.SFN_Time,id:675,x:31412,y:33112,varname:node_675,prsc:2;n:type:ShaderForge.SFN_Slider,id:1726,x:31227,y:32902,ptovrint:False,ptlb:PanSpeed,ptin:_PanSpeed,varname:node_1726,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Multiply,id:7547,x:31552,y:32963,varname:node_7547,prsc:2|A-1726-OUT,B-675-T;n:type:ShaderForge.SFN_TexCoord,id:4594,x:31541,y:32774,varname:node_4594,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Tex2d,id:7933,x:31929,y:32888,ptovrint:False,ptlb:NoiseTex,ptin:_NoiseTex,varname:node_7933,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:8abb535ba92efc64980b0b034495b9b7,ntxv:0,isnm:False|UVIN-4899-UVOUT;n:type:ShaderForge.SFN_Lerp,id:2771,x:32162,y:32888,varname:node_2771,prsc:2|A-4360-UVOUT,B-7933-R,T-8426-OUT;n:type:ShaderForge.SFN_Slider,id:8426,x:31741,y:33088,ptovrint:False,ptlb:DistortStrength,ptin:_DistortStrength,varname:_node_1726_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_TexCoord,id:8955,x:31824,y:32242,varname:node_8955,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Multiply,id:5639,x:31746,y:32458,varname:node_5639,prsc:2|A-388-OUT,B-3946-T;n:type:ShaderForge.SFN_Time,id:3946,x:31521,y:32604,varname:node_3946,prsc:2;n:type:ShaderForge.SFN_Slider,id:388,x:31415,y:32367,ptovrint:False,ptlb:MainTexSpeed,ptin:_MainTexSpeed,varname:_PanSpeed_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Panner,id:4360,x:31980,y:32399,varname:node_4360,prsc:2,spu:1,spv:0|UVIN-8955-UVOUT,DIST-5639-OUT;proporder:5054-388-7933-1726-8426;pass:END;sub:END;*/

Shader "Planets/Gas Giant Shader" {
    Properties {
        _MainTex ("MainTex", 2D) = "white" {}
        _MainTexSpeed ("MainTexSpeed", Range(0, 1)) = 0
